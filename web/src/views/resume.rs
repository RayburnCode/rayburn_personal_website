            ...
            section { class: "mb-8",
                ...
                div { class: "mb-6",
                    ...
                    ul { class: "list-disc pl-6 space-y-1",
                        ...
                        li {
                            "Coordinate between multiple stakeholders including borrowers, loan officers, underwriters, and third-party vendors to collect and verify financial documentation, order property appraisals, and resolve file discrepancies."
                        }
                        li {
                            "Maintain organized loan files and documentation while meeting critical deadlines in a fast-paced lending environment."
                        }
                    }
                }
                ...
                div { class: "mb-6",
                    ...
                    ul { class: "list-disc pl-6 space-y-1",
                        ...
                        li {
                            "Applied financial analysis techniques to examine financial statements, related materials, and market conditions to determine the viability of loan applications."
                        }
                        li {
                            "Utilized appropriate tax analysis methods to assess cash flow and financial stability of applicants."
                        }
                    }
                }
                    ...
                    ol { class: "list-decimal pl-6 space-y-4",
                        li {
                            ...
                            ul { class: "list-disc pl-6 mt-1 space-y-1",
                                ...
                                li {
                                    "Review and analyze financial statements, tax returns and verify borrower's information to assess eligibility of loan programs."
                                }
                        ...
                        li {
                            ...
                            ul { class: "list-disc pl-6 mt-1 space-y-1",
                                ...
                                li {
                                    "Utilize knowledge of Lender Overlays and Guidelines to assure loans are tailored to fit client needs."
                                }
                            }
                        }
                    }
                ...
                div { class: "mb-6",
                    ...
                    ul { class: "list-disc pl-6 space-y-1",
                        ...
                        li {
                            "In charge of partnering with new companies to streamline collections processes as well as maintaining healthy business relations with the companies."
                        }
                    }
                }
            }
            ...
            section { class: "mb-8",
                ...
                div { class: "mb-4",
                    h5 { class: "text-lg font-semibold",
                        "San Diego State University, San Diego, CA — Bachelor Degree in Statistics – Emphasis in Actuarial Science"
                    }
                    p { class: "italic ", "August 2016 - December 2018" }
                }
                div {
                    h5 { class: "text-lg font-semibold",
                        "Grossmont Community College, El Cajon, CA — Associate's Degree in Mathematics"
                    }
                    p { class: "italic ", "September 2013 - June 2016" }
                }
            }
            hr { class: "my-6 border-gray-300 dark:border-gray-600" }
            // Skills Section
