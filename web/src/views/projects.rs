                ...
                div { class: "grid grid-cols-1 md:grid-cols-2 gap-6",
                    ...
                    div { class: "border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg transition-shadow",
                        ...
                        div { class: "flex flex-wrap gap-2 mb-4",
                            ...
                            span { class: "px-2 py-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded text-sm",
                                "JavaScript"
                            }
                            span { class: "px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded text-sm",
                                "Firebase"
                    ...
                    div { class: "border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow",
                        ...
                        div { class: "p-6",
                            ...
                            div { class: "flex flex-wrap gap-2 mb-4",
                                ...
                                span { class: "px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded text-sm",
                                    "PLA"
                                }
                            }
                            a {
